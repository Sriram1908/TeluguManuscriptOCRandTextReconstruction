...
OUTPUT_DIR = os.path.join(SCRIPT_DIR, "Type_5_Mixed_Chaos_Output")
...
DEGRADE_SIGMA = 42.0 # High grain for "Chaos" mode
...
if __name__ == "__main__":
    ...
    while word_idx < len(all_words):
        ...
        # 2. Final Layering: Salt/Pepper and Stains
        canvas = add_salt_and_pepper(canvas)
        apply_solid_white_stains(canvas, curr_x)

        name = f"chaos_mixed_{img_count:05d}"
    ...
    print(f"✅ Type 5 Mixed Chaos complete. Folder: {OUTPUT_DIR}")